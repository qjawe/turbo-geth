...
func NewMDBX() MdbxOpts {
	return MdbxOpts{
		...
		flags:      mdbx.NoReadahead | mdbx.Durable, // | mdbx.LifoReclaim,
	}
}
...
func (opts MdbxOpts) Open() (KV, error) {
	...
	err = env.SetOption(mdbx.OptDpReverseLimit, 4*1024) // default: 1024
	if err != nil {
		return nil, err
	}
	...
	if err = env.SetGeometry(-1, -1, int(opts.mapSize), int(4*datasize.GB), -1, -1); err != nil {
		return nil, err
	}
